...
На время финального production-релиза остановите запись пользователей: включите режим обслуживания, выполните миграцию, разверните проверенный релизный коммит, проведите короткую проверку и только затем возобновите работу. Это исключает появление новых значений между защитной проверкой и удалением старых колонок.
