...
const OFFICIAL_STAMP_SAVE_CHECK_ITEMS: SaveCheckSettingItem[] = [
  ...
  },
  {
    ...
    description: 'Для обычного стыка оба диаметра должны быть покрыты совокупностью действующих НАКС одного клейма и группы материалов. У соединения «У…» проверяется только диаметр меньшего материала.',
    example: 'D может покрыть одна строка НАКС, а T — другая подходящая строка того же клейма. Для У17 с D1 = 530 и D2 = 25 проверяется только D25.',
  },
  {
    id: 'officialThickness',
    label: 'Толщины T1/T2',
    description: 'Для обычного стыка обе толщины должны быть покрыты совокупностью действующих НАКС одного клейма и группы материалов. У соединения «У…» проверяется T того же меньшего материала.',
    example: 'T может покрыть другая строка НАКС, чем D. Для У17 с D1/T1 = 530/30 и D2/T2 = 25/3 проверяется связанная пара D25/T3.',
  },
  {
    id: 'officialDls',
    label: 'Требовать подходящий ДЛС',
    description: 'Каждое официальное клеймо должно иметь действующие ДЛС нужного способа и группы. Диаметры и толщины независимо покрываются совокупностью его подходящих ДЛС.',
    example: 'D может покрыть один ДЛС, а T — другой ДЛС того же клейма, способа и группы. Между разными сварщиками диапазоны не складываются.',
  },
]
