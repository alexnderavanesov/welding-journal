  ...
  },
  {
    ...
    items: [
      ...
      },
      {
        ...
        description: 'Показывать задачи по НАКС, способу сварки, диаметру, сроку действия и отстранению.',
      },
      {
...
export const DISPATCHER_SETTING_HELP: Record<DispatcherSettingId, { meaning: string; example: string }> = {
  ...
  'check-welder-stamp': {
    meaning: 'Проверяет официальные клейма по реестру: НАКС, способ сварки, диаметр, срок действия и отстранения.',
