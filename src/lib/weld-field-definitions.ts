...
export const WELD_FIELDS = [
  ...
  { key: 'hasRfa', dbName: 'has_rfa', label: 'Назначение РФА', kind: 'boolean', group: 'Контроль' },
  { key: 'hasStls', dbName: 'has_stls', label: 'Назначение СТЛС', kind: 'boolean', group: 'Контроль' },
  { key: 'hasMkk', dbName: 'has_mkk', label: 'Назначение МКК', kind: 'boolean', group: 'Контроль' },
  ...
  { key: 'rfaControlBasis', dbName: 'rfa_control_basis', label: 'Основание РФА', kind: 'text', group: 'Контроль' },
  { key: 'stlsControlBasis', dbName: 'stls_control_basis', label: 'Основание СТЛС', kind: 'text', group: 'Контроль' },
  { key: 'mkkControlBasis', dbName: 'mkk_control_basis', label: 'Основание МКК', kind: 'text', group: 'Контроль' },
  {
  ...
  { key: 'rfaRequestDate', dbName: 'rfa_request_date', label: 'Дата заявки РФА', kind: 'date', group: 'Контроль', visible: true },
