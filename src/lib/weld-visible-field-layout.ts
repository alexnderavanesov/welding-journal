...
const TABLE_LAYOUT = [
  ...
  { section: 'Статус', columns: ['Официальность', 'Актуальность по ИЗМу'] },
  { section: 'Спул', columns: ['Спул', 'ID cпула'] },
  { section: 'Стык', columns: ['Стык'] },
  {
    section: 'Материалы',
    columns: [
      'Материал 1',
  ...
  },
  {
    ...
    columns: [
      'Заявка ВИК до ТО',
      'Дата заявки ВИК до ТО',
      'Результат ВИК до ТО',
      'Дата ВИК до ТО',
      'Заключение ВИК до ТО',
      'Заявка РК до ТО',
      'Дата заявки РК до ТО',
      'Результат РК до ТО',
      'Дата РК до ТО',
      'Заключение РК до ТО',
      'Снимки РК до ТО (координаты мерного пояса)',
      'Описание дефектов РК до ТО',
      'Заявка УЗК до ТО',
      'Дата заявки УЗК до ТО',
      'Результат УЗК до ТО',
      'Дата УЗК до ТО',
      'Заключение УЗК до ТО',
      'Заявка ПВК до ТО',
      'Дата заявки ПВК до ТО',
      'Результат ПВК до ТО',
      'Дата ПВК до ТО',
      'Заключение ПВК до ТО',
    ],
  },
  {
    section: 'Заявки',
