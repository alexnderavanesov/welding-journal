...
export const weldJoints = pgTable(
  'weld_joints',
  {
    ...
    elementLength1: numericNumber('element_length_1'),
    elementLength2: numericNumber('element_length_2'),
    ...
    legacyHasRfa: text('has_rfa'),
    legacyHasStls: text('has_stls'),
    legacyHasMkk: text('has_mkk'),
    vikControlBasis: text('vik_control_basis'),
    rkControlBasis: text('rk_control_basis'),
    uzkControlBasis: text('uzk_control_basis'),
    pvkControlBasis: text('pvk_control_basis'),
    tvmtControlBasis: text('tvmt_control_basis'),
    legacyRfaControlBasis: text('rfa_control_basis'),
    legacyStlsControlBasis: text('stls_control_basis'),
    legacyMkkControlBasis: text('mkk_control_basis'),
    ...
    legacyRfaRequest: text('rfa_request'),
    legacyRfaRequestDate: date('rfa_request_date'),
    legacyStlsRequest: text('stls_request'),
    legacyStlsRequestDate: date('stls_request_date'),
    legacyMkkRequest: text('mkk_request'),
    legacyMkkRequestDate: date('mkk_request_date'),
    ...
    legacyRfaResult: text('rfa_result'),
    legacyStlsResult: text('stls_result'),
    legacyMkkResult: text('mkk_result'),
    vikConclusionDate: date('vik_conclusion_date'),
    vikConclusion: text('vik_conclusion'),
    vikDefectDescription: text('vik_defect_description'),
    ...
    pvkDefectDescription: text('pvk_defect_description'),
    uzkConclusionDate: date('uzk_conclusion_date'),
    uzkConclusion: text('uzk_conclusion'),
    uzkDefectDescription: text('uzk_defect_description'),
    tvmtConclusionDate: date('tvmt_conclusion_date'),
    tvmtConclusion: text('tvmt_conclusion'),
    legacyRfaConclusionDate: date('rfa_conclusion_date'),
    legacyRfaConclusion: text('rfa_conclusion'),
    legacyStlsConclusionDate: date('stls_conclusion_date'),
    legacyStlsConclusion: text('stls_conclusion'),
    legacyMkkConclusionDate: date('mkk_conclusion_date'),
    legacyMkkConclusion: text('mkk_conclusion'),
    ...
    legacyRfaBoq: text('rfa_boq'),
    legacyRfaKs3: text('rfa_ks3'),
    legacyStlsBoq: text('stls_boq'),
    legacyStlsKs3: text('stls_ks3'),
    legacyMkkBoq: text('mkk_boq'),
    legacyMkkKs3: text('mkk_ks3'),
