...
export function PstoRequestAside() {
  return (
    <section className="min-h-0 space-y-3 overflow-y-auto pr-1">
      ...
      <DialogHelpNote>
        После создания наименование попадет в столбец «Заявка ПСТО», а время «Обновлен ПСТО» станет текущим. «Внесен ПСТО» сохраняет время первого появления стыка в отчете.
      </DialogHelpNote>
    </section>
  )
}
